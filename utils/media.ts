export const resolveImageUrl = (url?: any): string => {
...
export const getYoutubeEmbedUrl = (url: any, autoplay: boolean = true, mute: boolean = false): string | null => {
    ...
    try {
        ...
        return `https://www.youtube.com/embed/${videoId}?autoplay=${autoplayParam}&mute=${muteParam}&controls=1&modestbranding=1&origin=${encodeURIComponent(origin)}`;
    } catch (e) {
