...
interface AddKaryaAsatidzModalProps {
  onClose: () => void;
  onSave: (work: Omit<KaryaAsatidz, 'id'>) => void;
}

const AddKaryaAsatidzModal: React.FC<AddKaryaAsatidzModalProps> = ({ onClose, onSave }) => {
    ...
    >
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-800">Tambah Karya Ulama Persis</h2>
...
export default AddKaryaAsatidzModal;