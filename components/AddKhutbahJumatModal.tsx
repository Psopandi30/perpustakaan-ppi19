...
interface AddKhutbahJumatModalProps {
  onClose: () => void;
  onSave: (work: Omit<KhutbahJumat, 'id'>) => void;
}

const AddKhutbahJumatModal: React.FC<AddKhutbahJumatModalProps> = ({ onClose, onSave }) => {
    ...
    >
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-800">Tambah Khutbah Jum'at</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="addIsFeaturedKhutbah"
              name="isFeatured"
              checked={formData.isFeatured}
              onChange={handleChange}
              className="rounded border-gray-300 text-brand-yellow focus:ring-brand-yellow"
            />
            <label htmlFor="addIsFeaturedKhutbah" className="text-sm text-gray-700 font-medium">
...
export default AddKhutbahJumatModal;