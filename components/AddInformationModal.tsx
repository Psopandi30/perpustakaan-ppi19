...
interface AddInformationModalProps {
  onClose: () => void;
  onSave: (information: Omit<Information, 'id'>) => void;
}

const AddInformationModal: React.FC<AddInformationModalProps> = ({ onClose, onSave }) => {
    ...
    >
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label htmlFor="add-isi" className="block text-sm font-medium text-gray-700 mb-1">
                Tulis Informasi
            </label>
            <textarea
                id="add-isi"
