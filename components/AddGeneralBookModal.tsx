...
interface AddGeneralBookModalProps {
  onClose: () => void;
  onSave: (book: Omit<GeneralBook, 'id'>) => void;
}

const AddGeneralBookModal: React.FC<AddGeneralBookModalProps> = ({ onClose, onSave }) => {
...
export default AddGeneralBookModal;