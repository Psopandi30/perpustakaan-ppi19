...
interface EditKhutbahJumatModalProps {
  work: KhutbahJumat;
  onClose: () => void;
  onSave: (work: KhutbahJumat) => void;
}

const EditKhutbahJumatModal: React.FC<EditKhutbahJumatModalProps> = ({ work, onClose, onSave }) => {
  const [formData, setFormData] = useState<KhutbahJumat>({
    ...work,
    ...
    >
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center p-4 border-b sticky top-0 bg-white">
          <h2 className="text-xl font-semibold text-gray-800">Edit Khutbah Jum'at</h2>
...
export default EditKhutbahJumatModal;
