...
interface EditGeneralBookModalProps {
  book: GeneralBook;
  onClose: () => void;
  onSave: (book: GeneralBook) => void;
}

const EditGeneralBookModal: React.FC<EditGeneralBookModalProps> = ({ book, onClose, onSave }) => {
  const [formData, setFormData] = useState<GeneralBook>({
    ...book,
    tanggalTerbit: toDateInputValue(book.tanggalTerbit),
  });
...
export default EditGeneralBookModal;
